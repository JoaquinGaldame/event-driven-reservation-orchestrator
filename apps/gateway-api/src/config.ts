...
export const config: GatewayApiConfig = {
  port: readPositiveInteger("PORT", 3000),
  jwtSecret: readRequiredString(
    "JWT_SECRET",
    "dev-only-gateway-jwt-secret-change-me",
  ),
  jwtExpiresInSeconds: readPositiveInteger("JWT_EXPIRES_IN_SECONDS", 3600),
  ...
  kafka: {
    ...
    clientId: readRequiredString("KAFKA_CLIENT_ID", "gateway-api"),
    groupId: readRequiredString("KAFKA_GROUP_ID", "gateway-api"),
    service: "gateway-api",
  },
  outbox: {
